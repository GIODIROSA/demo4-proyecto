          ...
          <v-card>
            ...
            <v-container>
              ...
              <p class="text-justify font-weight-light py-3 ">
                ...
                otros se unan a ti. Los propietarios de automóviles establecen
                su propio precio para compartir el costo del combustible, y es
                una forma barata y ecológica de hacer nuevos amigos y encontrar
                socios delirantes para toda la vida.
              </p>
            </v-container>
          </v-card>
        </v-dialog>
